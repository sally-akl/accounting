                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="btnAQ">
                                                                      ...
                                                                      <!--  <a href="#" class="m-portlet__nav-link btn btn-lg btn-secondary  m-btn m-btn--outline-2x m-btn--air m-btn--icon m-btn--icon-only m-btn--pill  m-dropdown__toggle" id="delett">
                                                                        ...
                                                                        <a href="{{ url('job/create/0') }}">
                                                                            <button type="button" class="btnNew"><i class="fa fa-plus"></i>@lang('app.new_job')</button>
                                                                        </a>
                                                                </div>
                                                                </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($jobs as $key => $job)
																																				...
																																				<tr>
																																						...
																																						<td>
																																								{{$job->job_code}}
                                                                                <a href="{{url("job/{$job->id}/editcode")}}" style="margin-left: 5px;color: red;">  @lang('app.edit')</a>
																																						...
																																						<td>
																																							<a href="#" class="deleted_btn" data-title="{{$job->id}}">	<i class="la la-trash"></i> </a>

																																							<a href='{{url("job/{$job->id}/edit")}}'>	<i class="la la-edit"></i></a>
																																							<a href='{{url("job/{$job->id}/show")}}'>	<i class="la la-eye" data-toggle="modal" data-target="#m_modal_6"></i></a>
                                                      ...
                                                      {{$jobs->links('vendor.pagination.default')}}
														...
														<script type="text/javascript">
															 $(".deleted_btn").on("click",function(){
																 ...
																 var url_delete = '{{url("job/index")}}'+"/"+id
