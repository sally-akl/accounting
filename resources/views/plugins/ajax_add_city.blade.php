@if(Auth::user()->AllowToPath("add_city"))
  <a href="#" style="display:inline" class="add_new_city">
     <button type="button" class="btn btn-primary" style="margin-right: 5px;"><i class="fas fa-plus" style="margin-right: 6px;"></i>@lang('app.add_new_city')</button>
  </a>
@endif
...
$(".add_new_city").on("click",function(){
       ...
       var create_form_url = '{{url("city/create/0")}}/{{app()->getLocale()}}'
