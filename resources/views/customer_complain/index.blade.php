																													 ...
																													 <div class="col-lg-6">
																															 ...
																															 <div class="row">
																																 <div class="col-lg-12 mg-top25">
																																		  @include("customer_complain.sub_add")
               	...
               	<section id="add-form" class="search_switch_form">
																											 ...
																											 <div class="row align-items-center justify-content-center">
																													 <div class="card col-lg-12 padding20">
																														 ...
																														 <div class="col-lg-6">
																																 ...
																																 <div class="row">
																																	 <div class="col-lg-12 mg-top25">
																																		  @include("customer_complain.search")
								 ...
								 <div class="container-fluid">
									 <div class="row align-items-center justify-content-center">
											 <div class="card col-lg-12 custyle">
												 <div class="row">
													 <div class="col-lg-12 mg-top25">
														 <label class="form-control-label"><i class="fas fa-cog"></i> @lang('app.list_of_customer_complain')</label>
                             ...
                             @foreach ($customer_requests as $key => $c_request)
														 ...
														 <tr>
															 ...
															 <td data-label="@lang('app.status')"> <?php echo $c_request->status == 1 ? trans('app.open') : trans('app.close') ?></td>
															 <td data-label="@lang('app.submit_user_name')">	{{$c_request->users != null ?$c_request->users->name:""	}}

															 </td>

															 <td class="text-center">
																 <a class='btn btn-info btn-xs' href='{{url("customercomplain/{$c_request->id}/edit")}}/{{$id}}/{{app()->getLocale()}}?branch={{ Request::query("branch") }}'>
...
<script type="text/javascript">
							 $(".deleted_btn").on("click",function(){
								 ...
								 var url_delete = '{{url("customercomplain/index")}}'+"/"+id+'/{{app()->getLocale()}}'
													$.ajax({url: url_delete , success: function(result){
															 ...
															 if(result.sucess)
															 {
																	 window.location.href = '{{url("/customercomplain")}}/{{$id}}/{{app()->getLocale()}}?branch={{ Request::query("branch") }}';
															 }
														}});
								 });
</script>
