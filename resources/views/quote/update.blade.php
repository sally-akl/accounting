...
<!--begin::Portlet-->
                            ...
                            @include("utility.error_messages")
                              ...
                              <form method="POST" action='{{url("quote/{$quote->id}")}}'>
                                  @csrf
                                                            <div class="row addConntent">
                                                                <div class="col-xl-12">
                                                                  ...
                                                                  <div class="form-group m-form__group">
  																																		...
  																																		<input type="text"  name= "subject" class="form-control m-input" placeholder="{{ __('app.enter_subject') }}" value="{{$quote->quote_subject}}">
                                                                  ...
                                                                  <div class="form-group m-form__group">
                                                                      ...
                                                                      <input type="text"  name= "quote_date" class="form-control m-input" id="m_datepicker_1" readonly="" placeholder="{{ __('app.enter_quote_date') }}" value="{{$quote->quote_date}}">
                                                                  </div>
                                                                  ...
                                                                  <div class="form-group m-form__group">
                                                                      ...
                                                                      <input type="text"  name= "expire_date" class="form-control m-input" id="m_datepicker_1" readonly="" placeholder="{{ __('app.enter_quote_expire_date') }}" value="{{$quote->quote_expire_date}}">
                                                                  </div>
                                                                  ...
                                                                  <div class="form-group m-form__group">
                                                                      ...
                                                                      <input type="text"  name= "quote_discount" class="form-control m-input" placeholder="{{ __('app.enter_quote_discount') }}" value="{{$quote->quote_discount_amount}}">
									...
									<div class="d-flex align-items-center">
										<div class="mr-auto">
											...
											<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
												...
												<li class="m-nav__item">
													<a href='{{url("quote/{$quote->id}/edit")}}'  class="m-nav__link">
														<span class="m-nav__link-text">
															@lang('app.update_new_quotes')
														</span>
													</a>
