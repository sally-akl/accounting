                                                                    ...
                                                                    <div class="btnAQ">
                                                                      ...
                                                                      <!--  <a href="#" class="m-portlet__nav-link btn btn-lg btn-secondary  m-btn m-btn--outline-2x m-btn--air m-btn--icon m-btn--icon-only m-btn--pill  m-dropdown__toggle" id="delett">
                                                                        ...
                                                                        <a href="{{ url('city/create') }}">
                                                                            <button type="button" class="btnNew"><i class="fa fa-plus"></i>@lang('app.new_city')</button>
                                                                        </a>
                                                                </div>
                                                                </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($cities as $key => $city)
                                                                                ...
                                                                                {{$city->country->title}}
																																						...
																																						<td>
																																							<a href="#" class="deleted_btn" data-title="{{$city->id}}">	<i class="la la-trash"></i> </a>

																																							<a href='{{url("city/{$city->id}/edit")}}'>	<i class="la la-edit"></i></a>
																																							<a href='{{url("city/{$city->id}/show")}}'>	<i class="la la-eye" data-toggle="modal" data-target="#m_modal_6"></i></a>
                                                      ...
                                                      {{$cities->links('vendor.pagination.default')}}
														...
														<script type="text/javascript">
															 $(".deleted_btn").on("click",function(){
																 ...
																 var url_delete = '{{url("city/index")}}'+"/"+id
