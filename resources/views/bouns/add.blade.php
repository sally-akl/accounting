...
<!--begin::Portlet-->
                            ...
                            @include("utility.error_messages")
                              ...
                              <form method="POST" action="{{ url('bouns/store') }}">
                                  @csrf
                                                            <div class="row addConntent">
																																...
																																<div class="form-group m-form__group">
																																		...
																																		<div class="row">
																																				...
																																				<div class="col-xl-3" style="padding:11px;">
																																					<a href="{{ url('employeemajor/create/bouns') }}" style="text-decoration:none;color:#000;"><i class="fa fa-plus" style="margin-right: 5px;"></i>New Employee Salary</a>
																																				</div>
																																		</div>
                                                                ...
                                                                <div class="row btnAddn">
                                                                    <div class="col-xl-12">
                                                                        <input type="submit" class="btn btn-success m-btn m-btn--pill" data-toggle="modal" data-target="#m_markdown_modal" value="{{ __('app.add_new_bouns') }}">
									...
									<div class="d-flex align-items-center">
										<div class="mr-auto">
											...
											<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
												...
												<li class="m-nav__item">
													<a href='{{url("/bouns/create")}}'  class="m-nav__link">
														<span class="m-nav__link-text">
															@lang('app.add_new_bouns')
														</span>
													</a>
