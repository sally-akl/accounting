                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="btnAQ">
                                                                      ...
                                                                      <!--  <a href="#" class="m-portlet__nav-link btn btn-lg btn-secondary  m-btn m-btn--outline-2x m-btn--air m-btn--icon m-btn--icon-only m-btn--pill  m-dropdown__toggle" id="delett">
                                                                        ...
                                                                        <a href="{{ url('bouns/create') }}">
                                                                            <button type="button" class="btnNew"><i class="fa fa-plus"></i>@lang('app.new_bouns')</button>
                                                                        </a>
                                                                </div>
                                                                </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($bouns as $key => $b)
																																				...
																																				<tr>
																																						...
																																						<td>
																																								{{App\employee::find($b->employeeMajorData->emplyee_id)->employee_name}}
																																						</td>

																																						<td>

																																								{{App\major::find($b->employeeMajorData->major_id)->title}}
																																						</td>
																																						...
																																						<td>
																																							<a href="#" class="deleted_btn" data-title="{{$b->id}}">	<i class="la la-trash"></i> </a>

																																							<a href='{{url("bouns/{$b->id}/edit")}}'>	<i class="la la-edit"></i></a>
																																							<a href='{{url("bouns/{$b->id}/show")}}''>	<i class="la la-eye" data-toggle="modal" data-target="#m_modal_6"></i></a>
                                                      ...
                                                      {{$bouns->links('vendor.pagination.default')}}
														...
														<script type="text/javascript">
															 $(".deleted_btn").on("click",function(){
																 ...
																 var url_delete = '{{url("bouns/index")}}'+"/"+id
																					$.ajax({url: url_delete , success: function(result){
																						   ...
																						   console.log(result);
																							 if(result.sucess)
																							 {
																								   window.location.href = '{{url("/bouns")}}';
																							 }
																						}});
