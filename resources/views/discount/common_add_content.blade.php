     ...
     <div class="col-sm-9">
         <select name="emp_m_id" class="form-control {{ $errors->has('emp_m_id') ? ' is-invalid' : '' }}">
           ...
           @endforeach
             ...
             <a href="{{ url('employeemajor/create/discount/0') }}/{{app()->getLocale()}}?branch={{ Request::query('branch') }}" style="text-decoration:none;color:#000;"><i class="fa fa-plus" style="margin-right: 5px;"></i>@lang('app.new_employee_salary')</a>
     </div>
 </div>
 @else
