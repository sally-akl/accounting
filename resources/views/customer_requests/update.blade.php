													 ...
													 <div class="col-lg-12">
															 <div class="card">
																	 <div class="card col-lg-12 padding20">
																			 <div class="row">
																					 <div class=" mg-top25">
																							 <label class=" form-control-label"> <i class="far fa-edit"></i> @lang('app.update_cu_request')</label>
																					 </div>
																			 </div>
																			 <div class="row">
																					 <div class="col-lg-12 mg-top30">
																						   @include("utility.error_messages")
																							 <form method="POST" action='{{url("customerrequests/{$customer_requests_complain->id}")}}/{{app()->getLocale()}}?branch={{ Request::query("branch") }}'>
								                                   @csrf
																									 <div class="form-group row">
																													 ...
																													 <div class="form-group row">
																																	 ...
																																	 <div class="col-sm-9">
																																		 <textarea rows="10" cols="70"  name="message" >{{  $customer_requests_complain->message}}</textarea>
