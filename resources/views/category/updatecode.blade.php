...
<!--begin::Portlet-->
                            ...
                            @include("utility.error_messages")
                              ...
                              <form method="POST" action='{{url("category/updatecode/{$category->id}")}}'>
                                  @csrf
                                                            <div class="row addConntent">
                                                                <div class="col-xl-12">
																																...
																																<div class="form-group m-form__group">
																																		...
																																		<input type="text"  name= "category_code" class="form-control m-input" placeholder="{{ __('app.enter_category_code') }}" value="{{$category->category_code}}">
									...
									<div class="d-flex align-items-center">
										<div class="mr-auto">
											...
											<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
												...
												<li class="m-nav__item">
													<a href='{{url("category/{$category->id}/editcode")}}'  class="m-nav__link">
														<span class="m-nav__link-text">
															@lang('app.update_category_code')
														</span>
													</a>
